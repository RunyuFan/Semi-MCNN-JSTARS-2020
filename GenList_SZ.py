...
root = '.\\ShenzhenLC56-5-5\\train_data\\'
# root = '.\\GenDatasetShenzhenLC\\'
...
# Trainfile = open("./data/trainShenzhenLC-gen.txt", "w")
Trainfile = open("./data/trainShenzhenLC-5-5.txt", "w")

for str1 in Trainlist:
    Trainfile.write(str1)
Trainfile.close()

root = '.\\ShenzhenLC56-5-5\\test_data\\'
# dict = label_of_directory(root)
# print(dict)
...
Testlist = alllist
Testfile = open("./data/testShenzhenLC-5-5.txt", "w")
