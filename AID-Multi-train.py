...
def main(args):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if acc_1 > best_acc_1:
            ...
            torch.save(model1, os.path.join(args.model_path, 'AID-30-teacher-ResNet50.pth'))
            best_acc_1 = acc_1
        if acc_2 > best_acc_2:
        ...
        if acc_3 > best_acc_3:
            ...
            torch.save(model3, os.path.join(args.model_path, 'AID-30-teacher-shufflenetv2_x1.pth'))
            best_acc_3 = acc_3
    print("Model save to %s."%(os.path.join(args.model_path, 'AID-30-teacher-model.pth')))
