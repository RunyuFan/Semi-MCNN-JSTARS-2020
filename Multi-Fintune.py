...
def main(args):
    ...
    train_datasets = CarDateSet('G:\\LULC\\PytorchLULC\\Shenzhen56\\', "./data/train5-5.txt", transforms=None)

    test_datasets = CarDateSet('G:\\LULC\\PytorchLULC\\Shenzhen56\\', "./data/valid5-5.txt", transforms=None)
    ...
    if args.pretrained:
        ...
        model1 = torch.load('./model/ResNet50-weak-1000-2-8-lulc-6.pth.')
        # model2 = ResNet34()
        model2 = torch.load('./model/resnext50_32x4d-weak-1000-2-8-lulc-6.pth.')
        model3 = torch.load('./model/MSDNet-weak-1000-2-8-lulc-6.pth.')
