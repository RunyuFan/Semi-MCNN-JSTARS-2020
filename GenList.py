...
root = '.\\ShenzhenLC56-6-4\\train_data\\'
# root = '.\\GenDatasetShenzhenLC56-6-4\\'
...
Trainfile = open("./data/trainShenzhenLC56-6-4-teacher.txt", "w")
# Trainfile = open("./data/trainShenzhenLC56-6-4-gen.txt", "w")

for str1 in Trainlist:
    Trainfile.write(str1)
Trainfile.close()

root = '.\\ShenzhenLC56-6-4\\test_data\\'
# dict = label_of_directory(root)
# print(dict)
...
Testlist = alllist
Testfile = open("./data/testShenzhenLC56-6-4-teacher.txt", "w")
