...
def main(args):
    ...
    if args.pretrained:
        ...
        model1.load_state_dict(torch.load(args.pretrained_model))
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if acc_1 > best_acc_1:
            ...
            torch.save(model1, os.path.join(args.model_path, 'NWPU-45-teacher-ResNet50-1.pth'))
            best_acc_1 = acc_1
    #     if acc_2 > best_acc_2:
    ...
    #         torch.save(model3, os.path.join(args.model_path, 'NWPU-45-teacher-densenet121-%s.pth' % (args.model_name)))
    #         best_acc_3 = acc_3
...
if __name__ == '__main__':
    ...
    parser.add_argument("--pretrained_model", default='./ImageNet-models/resnet50-19c8e357.pth', type=str)
